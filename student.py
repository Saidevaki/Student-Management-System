...
class studentClass:
    def __init__(self, root):  # Corrected constructor
        ...
        txt_pin=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,"bold"),bg="lightyellow").place(x=560,y=220,width=120)
...
if __name__ == "__main__":
    root = Tk()
    obj = studentClass(root)  # This will now work
    root.mainloop()
